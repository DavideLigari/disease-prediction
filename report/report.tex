...
\abstract{  
    ...
    to classify symptoms and diseases based on their predictive power. These innovative metrics, along with traditional ones
    like betweenness centrality, are instrumental in refining our predictive models.\\
