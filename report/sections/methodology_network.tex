...
Additionally, an analysis of the node degree distribution was performed to assess whether the distribution follows a power law (see Section \ref{sec:results_network}\ref{subsubsec:power_law_ccdf}).\\
