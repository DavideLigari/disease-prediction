...
with a balanced precision and recall, effectively identifying true disease cases without false positives.
Low points, however, highlight areas where the model is less effective, either missing true cases
or falsely identifying healthy instances as diseased.
\begin{figure*}[htbp]
	\centering
	\includegraphics[width=.9\textwidth]{accuraci_diseases_best_model.png}
...
Table \ref{best} lists the top ten diseases where the model demonstrates flawless accuracy.
This exceptional performance is further highlighted by near-perfect f1-scores, indicating a commendable balance of precision and recall.
...
\begin{figure*}[htbp]
	\centering
	\includegraphics[width=.9\textwidth]{bladder_cancer_missclassified.png}
